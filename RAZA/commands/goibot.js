...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Talha") || (event.body.toLowerCase() == "admin")) {
  ...
  if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bhenchod")) {
    return api.sendMessage("ᴛᴜ ʜᴀɪ ʙᴄ ᴍᴀ ᴛᴏ ʙᴏᴛ ʜᴜɴ 😂😀", threadID);
  };

  if ((event.body.toLowerCase() == "ja rha") || (event.body.toLowerCase() == "ja rhi")) {
    return api.sendMessage("ᴀʀʏ ᴛᴏ ᴊᴀ ɴᴀ ᴋɪs ᴍʏ ʀᴏᴋᴀ ʜᴀ 😄😅 ", threadID);
  };

  if ((event.body.toLowerCase() == "nikal") || (event.body.toLowerCase() == "nikl")) {
    return api.sendMessage("ᴄʜᴀʟ ᴄʜᴀʟ ᴛᴜ ɴɪᴋᴀʟ 🙄😂👊", threadID);
  };

  if ((event.body.toLowerCase() == "jan") || (event.body.toLowerCase() == "janu")) {
    return api.sendMessage("ᴀᴡᴡ ʏᴇsʜ ᴍᴇʀɪ ᴊᴀᴀɴ 😍👊", threadID);
  };

  if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
    return api.sendMessage("sʜʀᴀғᴀᴛ sʏ ᴍᴜsᴋᴀʀᴀ ʀᴀʜᴀ ʜᴀɪɪ👊😁😂", threadID);
  };

  if ((event.body.toLowerCase() == "😃") || (event.body.toLowerCase() == "😃😃")) {
    return api.sendMessage("ᴄʜᴜʜʏ ᴊᴀsʏ ᴍᴜʜʜ ɴᴀ ᴅᴇᴋʜᴀ😝😆", threadID);
  };

  if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😂😂")) {
    return api.sendMessage("ᴀᴘɴʏ ᴅʜᴏɴɢʏ ᴊᴀsᴀ ᴍᴜʜʜ ᴋʜᴏʟ ᴋ ɢʀᴏᴜᴘ ᴍᴀ ᴠɪʀᴜs ɴᴀ ᴘʜᴇʟᴀᴏ😆😅😂", threadID);
  };

  if ((event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😁😁")) {
    return api.sendMessage("ᴛᴀʀʏ sʜᴋᴀʟ sʏ ᴢᴀᴅɪʏᴀ ᴛᴀʀʏ ᴅᴀɴᴛ ᴄʜᴍᴀᴋ ʀᴀʜʏ😁🤭😂", threadID);
  };

  if ((event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "😆😆")) {
    return api.sendMessage("ᴍᴜʜ ᴏᴘᴇɴ ᴀɴᴋʜʏ ʙᴀɴᴅ ʏᴀɪɪ ᴋᴏɴsɪ ʙᴇɢʜʀᴛɪ ʜᴀɪɪ 😀🙈🤝", threadID);
  };

  if ((event.body.toLowerCase() == "😅") || (event.body.toLowerCase() == "😅😅")) {
    return api.sendMessage("ᴛᴀʀʏ ᴛɪɴᴅ sʏ ᴘᴀɴɪɪ  ᴋʏᴜɴ  ᴛᴀᴘᴀᴋ ʀᴀʜᴀ🥲😂👊", threadID);
  };

  if ((event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "🤣🤣")) {
    return api.sendMessage("ʜᴀsɴʏ ᴋɪ ʙɪ ᴛᴀᴍɪᴢ ʜᴏᴛɪ ʜᴀɪ ʙᴇsʜʀᴀᴍ ᴍᴜʜ ʙɴᴅ ᴋᴀʀ😝🤪", threadID);
  };

  if ((event.body.toLowerCase() == "😭") || (event.body.toLowerCase() == "😭😭")) {
    return api.sendMessage("ʀᴏɴᴀ ᴛʜᴀᴡ ᴋɪᴀ 🙂🤨", threadID);
  };

  if ((event.body.toLowerCase() == "😉") || (event.body.toLowerCase() == "😉😉")) {
    return api.sendMessage("ᴀɴᴋʜ ɴᴀ ᴍᴀʀᴏ ᴍᴀ ʙʜᴏᴛ sʜᴀʀᴇᴇғ ʜᴜɴ 🤨🥵😁", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "🥰🥰")) {
    return api.sendMessage("ᴀᴡᴡ ᴄʜᴀʟ ʜᴀᴛ ᴛʜᴀᴛᴋɪ ɪɴsᴀɴ🙈", threadID);
  };

  if ((event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😍😍")) {
    return api.sendMessage("ᴀᴡᴡ ᴛᴀʀʏ ɪɪɴ ᴅɪʟ ᴡᴀʟɪ ᴀɴᴋʜᴏ ᴍᴀ ᴅᴏʙɴᴀ ᴄʜᴀʜᴛᴀ ʜᴜɴ 😆🙈💋", threadID);
  };

  if ((event.body.toLowerCase() == "🤦‍♂️") || (event.body.toLowerCase() == "🤦‍♂️🤦‍♂️")) {
    return api.sendMessage("ᴏʀ ᴢᴏʀ sʏ ᴍᴀʀᴏ ᴍᴇʀɪ  ᴍᴀɴᴛʏ ʜᴏ ᴛᴏ ᴀsᴀ ᴋʀᴏ ᴀᴘɴɪ sᴀʀ ᴅᴇᴠᴀʀ ᴍᴀ ᴍᴀʀᴏ 😕😹", threadID);
  };

  if ((event.body.toLowerCase() == "🥳") || (event.body.toLowerCase() == "🥳🥳")) {
    return api.sendMessage("𝐎𝐨𝐨𝐎𝐨𝐨𝐎𝐨ᴏ 𝐓𝐚𝐑𝐚 𝐡𝐚𝐩𝐩𝐲 𝐁𝐢𝐫𝐭𝐡𝐝𝐚𝐲😀🎉🎊", threadID);
  };

  if ((event.body.toLowerCase() == "🙃") || (event.body.toLowerCase() == "🙃🙃")) {
    return api.sendMessage("𝐌𝐞𝐫ʏ 𝐒𝐚𝐦𝐍𝐲 𝐀𝐧𝐤𝐡𝐲 𝐍𝐞𝐗𝐡𝐲 𝐑𝐚𝐊𝐡𝐚 𝐊𝐫𝐨 𝐒𝐡𝐚𝐛𝐒𝐡😃😚", threadID);
  };

  if ((event.body.toLowerCase() == "🙂") || (event.body.toLowerCase() == "🙂🙂")) {
    return api.sendMessage("𝐀𝐰ᴡ 𝐅𝐚𝐊𝐞 𝐒𝐦𝐢𝐥𝐞 𝐍𝐚 𝐃𝐨 𝐌𝐚 𝐇𝐮𝐧 𝐍𝐚 𝐁𝐚𝐛𝐲 🙂🥺🤭", threadID);
  };

  if ((event.body.toLowerCase() == "🥲") || (event.body.toLowerCase() == "🥲🥲")) {
    return api.sendMessage("𝐀𝐬ʏ 𝐌𝐮 𝐁𝐧𝐍𝐚 𝐊 𝐌𝐚𝐭 𝐑𝐨𝐨 𝐉𝐚𝐖𝐧🙂😂🥲👊", threadID);
  };

  if ((event.body.toLowerCase() == "😊") || (event.body.toLowerCase() == "😊😊")) {
    return api.sendMessage("𝐉𝐧ʙ 𝐘𝐢 𝐅𝐤𝐞 𝐒𝐦𝐢𝐥𝐞 𝐇𝐚𝐢🙂🙁🫡", threadID);
  };

  if ((event.body.toLowerCase() == "☺️") || (event.body.toLowerCase() == "☺️☺️")) {
    return api.sendMessage("𝐘ɪɪ 𝐒𝐦𝐢𝐥𝐞 𝐍𝐚 ᴅᴏ🙂💫🌟", threadID);
  };

  if ((event.body.toLowerCase() == "😌") || (event.body.toLowerCase() == "😌😌")) {
    return api.sendMessage("𝐌ᴜ 𝐁𝐚𝐍𝐝 𝐊𝐫 𝐌𝐚𝐤𝐇𝐢 𝐆𝐡𝐮𝐬 𝐆𝐲𝐞 𝐆𝐰👀🙊😂", threadID);
  };

  if ((event.body.toLowerCase() == "😏") || (event.body.toLowerCase() == "😏😏")) {
    return api.sendMessage("𝐉𝐚𝐒ʏ 𝐓𝐚𝐫𝐚 𝐌𝐮 𝐇𝐚𝐢 𝐖𝐬𝐲 𝐓𝐚𝐫𝐚 𝐀𝐭𝐭𝐢𝐭𝐮𝐝𝐞 𝐇𝐚𝐢 𝐁𝐡𝐨𝐃𝐬𝐤 😹😏", threadID);
  };

  if ((event.body.toLowerCase() == "😴") || (event.body.toLowerCase() == "😴😴")) {
    return api.sendMessage("𝐂𝐡𝐚ʟ 𝐉𝐚𝐚 𝐍𝐚𝐡𝐚 𝐊𝐫𝐫 𝐀𝐚😏👊🙂 ", threadID);
  };

  if ((event.body.toLowerCase() == "😪") || (event.body.toLowerCase() == "😪😪")) {
    return api.sendMessage("𝐂𝐡𝐞ᴇ 𝐂𝐡𝐞𝐞 𝐓𝐚𝐫 𝐍𝐚𝐤 𝐒𝐲 𝐁𝐮𝐥𝐁𝐮𝐥𝐲🙄😂😒👊💖", threadID);
  };

  if ((event.body.toLowerCase() == "🤤") || (event.body.toLowerCase() == "🤤🤤")) {
    return api.sendMessage("𝐌𝐞𝐫ʏ 𝐌𝐮 𝐁𝐡𝐢 𝐏𝐚𝐧𝐢𝐢 𝐀𝐚𝐑𝐀𝐡𝐚𝐚 𝐇𝐚𝐢𝐢😂😏", threadID);
  };

  if ((event.body.toLowerCase() == "😋") || (event.body.toLowerCase() == "😋😋")) {
    return api.sendMessage("𝐙𝐮𝐁𝐚ɴ 𝐀𝐧𝐝𝐫 𝐊𝐫 𝐖𝐚𝐫𝐧𝐚 𝐊𝐚𝐭 𝐊 𝐓𝐚𝐫𝐲 𝐇𝐚𝐭 𝐌𝐚 𝐑𝐚𝐤𝐡 𝐃𝐧 𝐆𝐰", threadID);
  };

  if ((event.body.toLowerCase() == "😛") || (event.body.toLowerCase() == "😛😛")) {
    return api.sendMessage("𝐀𝐰ᴡ 𝐚𝐠𝐚𝐧𝐝𝐚 𝐂𝐡𝐞𝐞 𝐂𝐡𝐞𝐞😂😃", threadID);
  };

  if ((event.body.toLowerCase() == "😝") || (event.body.toLowerCase() == "😝😝")) {
    return api.sendMessage("𝐀𝐛ʏ 𝐀𝐧𝐤𝐡𝐲 𝐊𝐡𝐨𝐥 𝐎𝐫 𝐙𝐮𝐛𝐚𝐧 𝐀𝐧𝐝𝐫 𝐊𝐫 𝐖𝐚𝐫𝐍𝐚 𝐊𝐚𝐭 𝐃𝐮𝐧 𝐠𝐰", threadID);
  };

  if ((event.body.toLowerCase() == "😜") || (event.body.toLowerCase() == "😜😜")) {
    return api.sendMessage("ʙᴀʀɪ ᴍᴀsᴛɪ ᴄʜᴀʀɪ ᴄʜᴀɪ ᴛᴇʀʏ ᴋᴏ 1 ᴀɴᴋʜ ʙᴀɴᴅ ᴋʀʀᴋᴇ ᴢᴜʙᴀɴ ʙʜɪʀ ᴀᴀɢʏɪ 😂😂😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "🥴") || (event.body.toLowerCase() == "🥴🥴")) {
    return api.sendMessage("sᴀsᴛᴀ ɴᴀsʜᴀ ᴋʀʀ ʟɪʏᴀ ʟᴀɢᴛᴀ ʜᴀɪ 😂😂", threadID);
  };

  if ((event.body.toLowerCase() == "😔") || (event.body.toLowerCase() == "😔😔")) {
    return api.sendMessage("𝑱𝒂𝑵ᴜ 𝑪𝒉𝒐𝑹 𝑮𝒂𝒚𝒂 𝒌𝒊𝒚𝒂😒😂", threadID);
  };

  if ((event.body.toLowerCase() == "🥺") || (event.body.toLowerCase() == "🥺🥺")) {
    return api.sendMessage("𝑯𝒂𝒀𝒆ᴇ 𝑩𝒂𝒃𝒀 𝑳𝒐𝒐𝒕𝒚 𝑵𝒊 𝑵𝒂𝒘 𝒀𝒆𝒆 𝑳𝒐𝒐 𝑷𝒊𝒊𝒐𝒐 🍼🥺", threadID);
  };

  if ((event.body.toLowerCase() == "😬") || (event.body.toLowerCase() == "😬😬")) {
    return api.sendMessage("ᴋɪss 𝒌𝒊 𝑩𝒂𝒋𝒂𝒂 𝑫𝒊𝒊𝒘😁🤨🧐", threadID);
  };

  if ((event.body.toLowerCase() == "😑") || (event.body.toLowerCase() == "😑😑")) {
    return api.sendMessage("𝑾𝒂ʜ 𝑴𝒖𝒖 𝑲𝒚 𝑺𝒂𝑻𝒉 𝑨𝒏𝒌𝒉𝒆 𝑩𝒆 𝑩𝒂𝒏𝒅 𝑯𝟎𝒐 𝑮𝒀𝒊 😁😂", threadID);
  };

  if ((event.body.toLowerCase() == "😐") || (event.body.toLowerCase() == "😐😐")) {
    return api.sendMessage("𝑻𝒆𝒓ʏ𝒚 𝑴𝒖𝒉𝒉 𝑷𝒚 𝑬𝒍𝒇𝒊𝒊𝒊 𝑳𝒈𝒂𝒘 𝑫𝒊 𝒌𝒀𝒂 𝒌𝒔𝒊 𝒏𝒚 😹", threadID);
  };

  if ((event.body.toLowerCase() == "😶") || (event.body.toLowerCase() == "😶😶")) {
    return api.sendMessage("𝑵𝒂ᴋ 𝑻𝟎𝒐 𝑻𝒉𝒊 𝑵𝒉𝒊 𝑴𝒖𝒖 𝑩𝒆 𝑮𝒚𝒃 𝑯𝟎𝒐 𝑮𝒀𝒂 𝑻𝒆𝑹𝒂😂😂😂", threadID);
  };

  if ((event.body.toLowerCase() == "🤐") || (event.body.toLowerCase() == "🤐🤐")) {
    return api.sendMessage("𝑨ɴ 𝑻𝒓𝒊𝒊 𝑨𝒘𝒂𝒛𝒛 𝑨𝒊 𝑵𝒂 𝑻𝟎𝒐 𝑴𝒆 𝑨𝒍𝒇𝒊 𝑺𝒚 𝑩𝒂𝑵𝒅 𝑲𝒓𝒖𝑵𝒈𝒂😁😒", threadID);
  };

  if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤔🤔")) {
    return api.sendMessage("𝐊𝐚𝐬ʜ 𝐃𝐞𝐦𝐠𝐡 𝐁𝐡𝐢 𝐙𝐮𝐛𝐚𝐧 𝐊𝐢 𝐓𝐚𝐫𝐚𝐡 𝐂𝐡𝐚𝐥𝐭𝐚 🙂😾😂", threadID);
  };

  if ((event.body.toLowerCase() == "🤫") || (event.body.toLowerCase() == "🤫🤫")) {
    return api.sendMessage("𝐓𝐚𝐫ɪ 𝐘𝐢 𝐔𝐧𝐆𝐥𝐢 𝐌𝐚𝐧𝐲 𝐓𝐚𝐫𝐲 𝐇𝐞 𝐍𝐚𝐤 𝐌𝐚 𝐃𝐲 𝐃𝐞𝐍𝐢𝐢😒😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "🥱") || (event.body.toLowerCase() == "🥱")) {
    return api.sendMessage(" 𝐀𝐣𝐚ᴀ 𝐁𝐚𝐛𝐲 𝐌𝐞𝐫𝐲 𝐏𝐚𝐬 𝐒𝐨𝐣𝐚𝐚😃😂😜", threadID);
  };

  if ((event.body.toLowerCase() == "🤗") || (event.body.toLowerCase() == "🤗🤗")) {
    return api.sendMessage("𝐏𝐡ʟʏ 𝐍𝐚𝐡𝐚 𝐊𝐫𝐫 𝐀𝐚 𝐏𝐡𝐢𝐫 𝐇𝐮𝐠 𝐃𝐧 𝐆𝐰😂", threadID);
  };

  if ((event.body.toLowerCase() == "😱") || (event.body.toLowerCase() == "😱😱")) {
    return api.sendMessage("𝐊𝐲ᴀ 𝐇𝐮𝐚 𝐒𝐡𝐞𝐡𝐢𝐚 𝐃𝐞𝐤𝐡 𝐋𝐢𝐲𝐚 𝐥𝐢𝐲𝐚 😳", threadID);
  };

  if ((event.body.toLowerCase() == "🤨") || (event.body.toLowerCase() == "🤨🤨")) {
    return api.sendMessage("𝐓ᴜ 𝐇𝐮𝐬𝐡𝐲𝐚𝐫 𝐁𝐚𝐧 𝐤𝐑𝐫 𝐍𝐚 𝐃𝐞𝐤𝐡 𝐌𝐚𝐢𝐧 𝐇𝐮𝐧 𝐍𝐚𝐰👊😂", threadID);
  };

  if ((event.body.toLowerCase() == "🧐") || (event.body.toLowerCase() == "🧐🧐")) {
    return api.sendMessage("𝐓ᴜ 𝐇𝐚𝐓 𝐌𝐚𝐢𝐧 𝐃𝐞𝐤𝐡𝐓𝐚 𝐇𝐮𝐧 🙃👀😂", threadID);
  };

  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒😒")) {
    return api.sendMessage("𝐀𝐬ʏ 𝐊𝐢𝐲𝐚 𝐃𝐞𝐤𝐡 𝐑𝐡𝐲 𝐇𝐨 𝐌𝐚𝐒𝐨𝐨𝐦 𝐊𝐢 𝐉𝐚𝐧 𝐋𝐨 𝐆𝐲 𝐊𝐢𝐲𝐚 🤧", threadID);
  };

  if ((event.body.toLowerCase() == "🙄") || (event.body.toLowerCase() == "🙄🙄")) {
    return api.sendMessage("𝐎𝐩ᴇʀ 𝐓𝐚𝐫𝐢 𝐍𝐚𝐧𝐢 𝐍𝐚𝐬𝐫𝐞𝐞𝐧 𝐡𝐚𝐢𝐢 𝐤𝐢𝐲𝐚𝐚 - 😕😂", threadID);
  };

  if ((event.body.toLowerCase() == "😤") || (event.body.toLowerCase() == "😤😤")) {
    return api.sendMessage("s𝐦𝐨𝐨𝐤𝐢𝐧ɢ 𝐊𝐫𝐍𝐚 𝐒𝐞𝐞𝐡𝐚𝐭 𝐤 𝐥𝐢𝐲𝐞 𝐭𝐡𝐤 𝐍𝐢 𝐤𝐫 𝐧𝐚𝐤 𝐬𝐲 𝐝𝐮𝐡𝐚𝐧 𝐍𝐞𝐤𝐚𝐥𝐧𝐚 𝐓𝐨 𝐨𝐫 𝐛𝐡𝐢 𝐊𝐚𝐭𝐚𝐫 𝐍𝐚𝐤 𝐇𝐚𝐢🤣😂", threadID);
  };

  if ((event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "😠😠")) {
    return api.sendMessage("𝐌𝐚𝐧ɢ 𝐓𝐲𝐚𝐚 𝐓𝐢𝐘𝐚 𝐇𝐚𝐢 𝐉𝐨 𝐆𝐡𝐮𝐒𝐬𝐚 𝐊𝐑𝐫 𝐑𝐚𝐡𝐘🥺😢", threadID);
  };

  if ((event.body.toLowerCase() == "😡") || (event.body.toLowerCase() == "😡😡")) {
    return api.sendMessage("𝐓𝐚𝐥ʜ𝐚 𝐍𝐲 𝐑𝐨𝐊𝐚 𝐇𝐚𝐢 𝐰𝐚𝐑𝐧𝐚 𝐓𝐚𝐫𝐢 𝐈𝐬 𝐆𝐮𝐒𝐬𝐲 𝐤𝐢 𝐁𝐡𝐢.........𝐬𝐦𝐚𝐣 𝐉𝐚 😁😝😂👊", threadID);
  };

  if ((event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "🤬🤬")) {
    return api.sendMessage("𝐀𝐰ᴡ 𝐉𝐚𝐰𝐧 𝐆𝐮𝐬𝐬𝐚 𝐧𝐢𝐢 𝐊𝐫𝐭𝐲😂😐", threadID);
  };

  if ((event.body.toLowerCase() == "😞") || (event.body.toLowerCase() == "😞😞")) {
    return api.sendMessage("𝐀𝐰ᴡ 𝐌𝐲𝐲 𝐥𝐎𝐯𝐞 𝐔𝐩𝐑 𝐔𝐭𝐇𝐚𝐨 𝐌𝐮𝐡😂👊", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "😢") || (event.body.toLowerCase() == "😢😢")) {
    return api.sendMessage("𝐋𝐨𝐨ᴏ𝐨 𝐍𝐢 𝐌𝐞𝐥𝐢𝐢 𝐉𝐚̀𝐰n😂👊", threadID);
  };

  if ((event.body.toLowerCase() == "☹️") || (event.body.toLowerCase() == "☹️☹️")) {
    return api.sendMessage("𝐀𝐰ᴡ 𝐁𝐚𝐛𝐲𝐲 𝐒𝐚𝐝 𝐍𝐚 𝐇𝐨 𝐌𝐚 𝐇𝐮𝐧 𝐍𝐚𝐰😙😒🥺", threadID);
  };

  if ((event.body.toLowerCase() == "🙁") || (event.body.toLowerCase() == "🙁🙁")) {
    return api.sendMessage("𝐀ᴡ𝐰 𝐁𝐚𝐁𝐲 𝐭𝐢𝐘𝐚 𝐇𝐮𝐚 😒😙☹️", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "😮") || (event.body.toLowerCase() == "😮😮")) {
    return api.sendMessage("𝐎ʏ𝐞𝐞 𝐎𝐲𝐞𝐞 𝐌𝐮𝐇𝐡 𝐁𝐚𝐧𝐝 𝐊𝐑𝐫 𝐖𝐫𝐧𝐚 𝐌𝐚𝐤𝐇𝐢 𝐂𝐡𝐚𝐥𝐢 𝐉𝐚𝐍𝐢 𝐇𝐚𝐢𝐢𝐢😂😂😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "😳") || (event.body.toLowerCase() == "😳😳")) {
    return api.sendMessage("𝐊𝐲ᴀ 𝐡𝐎𝐠𝐘𝐚 𝐈𝐧𝐧𝐚 𝐀𝐧𝐤𝐡𝐲 𝐏𝐡𝐚𝐑 𝐩𝐇𝐚𝐫 𝐊 𝐌𝐮𝐣𝐡𝐘 𝐤𝐮 𝐃𝐞𝐤𝐡 𝐑𝐚𝐡𝐲 𝐇𝐨😳😳😳", threadID);
  };

  if ((event.body.toLowerCase() == "🤯") || (event.body.toLowerCase() == "🤯🤯")) {
    return api.sendMessage("𝐓𝐞𝐫ʏ 𝐒𝐚𝐫 𝐌𝐞 𝐁𝐮𝐦𝐁 𝐊𝐢𝐬 𝐍𝐲 𝐏𝐡𝐨𝐑𝐚😒😂", threadID);
  };

  if ((event.body.toLowerCase() == "😖") || (event.body.toLowerCase() == "😖😖")) {
    return api.sendMessage("sʜᴀʏᴇᴅ 𝐒𝐚𝐝 𝐇𝐨𝐨 𝐤𝐀𝐚𝐚 𝐁𝐚𝐛𝐘😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "😩") || (event.body.toLowerCase() == "😫")) {
    return api.sendMessage("𝐂𝐡ᴀ𝐥 𝐇𝐚𝐓 𝐍𝐨𝐓𝐚𝐧𝐊𝐢𝐢😫😂😂", threadID);
  };

  if ((event.body.toLowerCase() == "😵") || (event.body.toLowerCase() == "😵😵")) {
    return api.sendMessage("𝐀s𝐡ᴀ 𝐇𝐚𝐢𝐢 𝐊 𝐌𝐚 𝐀𝐧𝐝𝐇𝐚 𝐇𝐮𝐧😂😟", threadID);
  };

  if ((event.body.toLowerCase() == "🥶") || (event.body.toLowerCase() == "sardi")) {
    return api.sendMessage("𝐀𝐰ᴡ 𝐁𝐚𝐁𝐞 𝐒𝐚𝐫𝐃𝐢 𝐋𝐚𝐠 𝐑𝐡𝐢 𝐓𝟎𝐨 𝐌𝐞𝐑𝐞 𝐏𝐚𝐒𝐬 𝐀𝐣𝐚𝐨🙈😜", threadID);
  };

  if ((event.body.toLowerCase() == "🥵") || (event.body.toLowerCase() == "🥵🥵")) {
    return api.sendMessage("𝐍𝐚𝐇ᴀ 𝐋𝐲 😂🥶", threadID);
  };

  if ((event.body.toLowerCase() == "🤢") || (event.body.toLowerCase() == "🤮")) {
    return api.sendMessage("ᴀ𝐚𝐚𝐚𝐚 𝐓𝐡𝐨𝟎𝐨𝐨", threadID);
  };

  if ((event.body.toLowerCase() == "🤧") || (event.body.toLowerCase() == "😷")) {
    return api.sendMessage("ᴀʀʏ ʙʜᴀɢ ᴊᴀᴏ ᴍᴇᴋᴏ ʙʜɪ ʙᴇᴇᴍᴀʀ ᴋʀ0ᴏ ɢᴀʏ 🥺", threadID);
  };

  if ((event.body.toLowerCase() == "🤒") || (event.body.toLowerCase() == "🤕")) {
    return api.sendMessage("ᴀᴡᴡ ʙᴀʙᴇ ᴋᴏ ᴛᴀ ʜᴜᴡᴀ ɪᴅʜᴇʀ ᴀᴏᴡ ᴛʜᴏʀᴀ ᴘʏᴀʟ ʟᴏ 😜💉💉💉", threadID);
  };

  if ((event.body.toLowerCase() == "😎") || (event.body.toLowerCase() == "😎😎")) {
    return api.sendMessage("ɢʟᴀssᴇs ʙʜɪ ɴᴇᴡ ʟᴇʟᴏ ᴀʙ 🙂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "🥸") || (event.body.toLowerCase() == "🤓")) {
    return api.sendMessage("ᴀɪɴᴇᴍ ᴡᴀʟᴀ ᴊɪɴ😂", threadID);
  };

  if ((event.body.toLowerCase() == "🤡") || (event.body.toLowerCase() == "🤡🤡")) {
    return api.sendMessage("ᴀᴡᴡ sʟᴏ sᴡᴇᴇᴛ 😂 ᴄᴀʀᴛ0ᴏɴ", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "😹") || (event.body.toLowerCase() == "😹😹")) {
    return api.sendMessage("ᴀʙʏ ʙɪʟʟɪ ᴍᴜʜ ʙɴᴅ ᴋᴇ 😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "😼") || (event.body.toLowerCase() == "😼😼")) {
    return api.sendMessage("ʏᴇ sᴀsᴛᴀ ᴀᴛᴛɪᴛᴜᴅᴇ ʜᴀᴍʏ ᴍᴀᴛ ᴅᴇᴋʜᴀ😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Choti") || (event.body.toLowerCase() == "choti")) {
  ...
  if ((event.body.toLowerCase() == "Hadi") || (event.body.toLowerCase() == "Hadii")) {
    return api.sendMessage("𝑯𝒂𝒅𝒊 𝑪𝒉𝒂𝒓𝒔 𝒑𝒆𝒏𝒚 𝒎𝒂 𝒃𝒖𝒔𝒚 𝒉𝒂𝒊 𝒅𝑶𝒔𝒕𝒕 👀😹", threadID);
  };

  if ((event.body.toLowerCase() == "Chutia") || (event.body.toLowerCase() == "chutiya")) {
    return api.sendMessage("Tᴜ ʜᴀɪ ᴄʜᴜᴛɪʏᴀ 🙂 ᴍᴀɪɴ ᴛᴏ ʙᴏᴛ ʜᴜɴ ɴᴀᴡ 🥺😂", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "xHOTI") || (event.body.toLowerCase() == "XHOTI")) {
    return api.sendMessage("𝐂𝐡𝐨𝐭𝐢𝐢 𝐏𝐞𝐧𝐂𝐡𝐚𝐫𝐨 𝐰𝐚𝐥𝐢𝐢 👀😹", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "huh") || (event.body.toLowerCase() == "hmm")) {
    return api.sendMessage("ᴋʏᴀ ʜᴍᴍ 🙄ᴛʜᴀʀᴋɪ", threadID);
  };

  if ((event.body.toLowerCase() == "acha") || (event.body.toLowerCase() == "acha g")) {
    return api.sendMessage("𝐇𝐚𝐧 ɢ😂👊", threadID);
  };
